		...
		<div className="project h-screen overflow-hidden bg-midnightBlack relative">
			<Container>
				<div className="project-grid hidden overflow-scroll-y-shadow-sm scroll-none overflow-y-scroll md:overflow-visible md:grid md:gap-x-6 md:gap-y-8 h-[calc(100vh-6rem)] md:h-[calc(100%-4rem)] w-10/12 mt-8 mx-auto">
					...
					<a className="live col-start-[10] col-end-[12] row-start-[6] row-end-[7] translate-y-3/4 md:translate-x-[-45%] xl:translate-x-[-40%] border flex items-center justify-center hover:bg-white hover:text-black rounded hover:rounded-xl duration-300 text-[15px]" href={project.liveLink ? project.liveLink : "#"}>Live View</a>
					<a className="github col-start-[12] col-end-[14] row-start-[6] row-end-[7] translate-y-3/4 translate-x-[-45%] translate-x-[-61%] xl:-translate-x-1/2 border flex items-center justify-center hover:bg-white hover:text-black rounded hover:rounded-xl duration-300 text-[15px]" href={project.github ? project.github : "#"}>Github</a>
					<Link to="/work" className="backBtn col-start-[9] col-end-[10] row-start-[6] row-end-[7] translate-y-3/4 -translate-x-1/2 border flex items-center justify-center hover:bg-white hover:text-black rounded hover:rounded-xl duration-300 text-[15px] w-5 md:w-1/2">{`<`}</Link>
					<div className="block md:hidden h-20"></div>
					<Image clickEvent={() => onEntr(0)} img={project.imgs ? project.imgs[0] : "https://placehold.co/400x400"} alt={project.title} colStartEnd="col-start-[2] col-end-[4]" rowStartEnd="row-start-[1] row-end-[3]" />
					<Image clickEvent={() => onEntr(1)} img={project.imgs ? project.imgs[1] : "https://placehold.co/400x400"} alt={project.title} colStartEnd="col-start-[4] col-end-[6]" rowStartEnd="row-start-[1] row-end-[3]" />
					<Image clickEvent={() => onEntr(2)} img={project.imgs ? project.imgs[2] : "https://placehold.co/400x400"} alt={project.title} colStartEnd="col-start-[1] col-end-[3]" rowStartEnd="row-start-[3] row-end-[5]" />
					<Image clickEvent={() => onEntr(3)} img={project.imgs ? project.imgs[3] : "https://placehold.co/400x400"} alt={project.title} colStartEnd="col-start-[3] col-end-[5]" rowStartEnd="row-start-[3] row-end-[5]" />
					<Image clickEvent={() => onEntr(4)} img={project.imgs ? project.imgs[4] : "https://placehold.co/400x400"} alt={project.title} colStartEnd="col-start-[3] col-end-[5]" rowStartEnd="row-start-[5] row-end-[7]" />
					<Image clickEvent={() => onEntr(5)} img={project.imgs ? project.imgs[5] : "https://placehold.co/400x400"} alt={project.title} colStartEnd="col-start-[5] col-end-[7]" rowStartEnd="row-start-[4] row-end-[6]" />
					<Image clickEvent={() => onEntr(6)} img={project.imgs ? project.imgs[6] : "https://placehold.co/400x400"} alt={project.title} colStartEnd="col-start-[5] col-end-[7]" rowStartEnd="row-start-[6] row-end-[8]" />
